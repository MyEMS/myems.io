...
## 从v5.10.0 升级到 v5.11.0 - 2025-11-30
### database
- 执行 myems/database/upgrade/upgrade5.11.0.sql
### myems-admin
- 必须重新安装，因为有新功能
### myems-aggregation
...
## 从v5.9.0 升级到 v5.10.0 - 2025-10-27
### database
- 执行 myems/database/upgrade/upgrade5.10.0.sql
### myems-admin
- 必须重新安装，因为有新功能
### myems-aggregation
- 可选重新安装，因为仅更改了 version.txt
...
## 从v5.8.0 升级到 v5.9.0 - 2025-9-28
### database
- 执行 myems/database/upgrade/upgrade5.9.0.sql
### myems-admin
- 必须重新安装，因为有新功能
### myems-aggregation
- 可选重新安装，因为仅更改了 version.txt
...
## 从v5.5.0 升级到 v5.6.0 - 2025-6-22
### database
- 执行 myems/database/upgrade/upgrade5.6.0.sql
### myems-admin
- 必须重新安装，因为有新功能
### myems-aggregation
- 可选重新安装，因为仅更改了 version.txt
...
## 从v5.2.0 升级到 v5.3.0 - 2025-3-28
### database
- 执行 myems/database/upgrade/upgrade5.3.0.sql
### myems-admin
- 必须重新安装，因为有新功能
### myems-aggregation
